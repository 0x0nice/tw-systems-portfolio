/**
 * Classic 2D Perlin noise — lightweight, zero-dependency implementation.
 * Used for terrain displacement in the Point Dume scene.
 */
...
/** Fractional Brownian Motion — layered Perlin noise for natural terrain */
export function fbm(
  x: number,
  y: number,
  octaves = 4,
